...
/*
	This spec was written mainly during the CVL Bootcamp in August'23 together by Antti, 
	Dominik, Martin, Otakar, Jaroslav and Nurit. These are our first rules so might not be
	the best ones. 
*/
...
//NOTE: We might consider adding other additive rules (just as an excercise).

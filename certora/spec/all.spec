...
//Otakar: have a more general rule
//Dominik: have a more general rule
//Antti:
//Martin: 
//Jaroslav: have a more general
//CAN BE REMOVED
...
//Martin: 
//Jaroslav: 
// is covered by a more general rule, e.g. by transferDoesTheTransfer
...
// Replaced by transferFromRevertingConditions
...
//same as burnDecreasesTheTotalBalanceCorrectly
//can be removed, we should check the balance instead of the total supply
//the total supply 
...
// we should also check the reverting conditions
// changes just the balance of [addr]
